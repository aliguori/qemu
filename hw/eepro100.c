...
static EEPRO100Class *eepro100_get_class(EEPRO100State *s)
{
    return (EEPRO100Class *)object_get_class(OBJECT(s));
}

static void e100_pci_reset(EEPRO100State * s)
{
    EEPRO100Class *klass = eepro100_get_class(s);
    ...
    s->stats_size = klass->stats_size;
    s->has_extended_tcb_support = klass->has_extended_tcb_support;
...
static void eepro100_class_init(ObjectClass *klass, void *data)
{
    ...
    EEPRO100Class *e = (EEPRO100Class *)klass;
    ...
    e->stats_size = info->stats_size;
    e->has_extended_tcb_support = info->has_extended_tcb_support;
    e->power_management = info->power_management;
}
